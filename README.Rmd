...
Let's start with the cats. The cats have a name and a temperament: they are good or bad. Let's call that goodness^[Incidently this is a great way to label things. Don't create a gender column with male or female (or other), but make the label the description: female TRUE/FALSE].
...
want to be pet. Margareth and Donald don't want to be cuddled. 
